...
void Key ( ESContext *esContext, unsigned char key, bool bIsPressed)
{
	switch (key)
	{
		case VK_UP /*arrowkey up*/:
			turnUp = bIsPressed;
			break;
		case VK_DOWN /*arrowkey down*/:
			turnDown = bIsPressed;
			break;
		case VK_LEFT /*arrowkey left*/:
			turnLeft = bIsPressed;
			break;
		case VK_RIGHT /*arrowkey right*/:
			turnRight = bIsPressed;
			break;
		case 0x41 /*A*/:
			leftValue = bIsPressed;
			break;
		case 0x44 /*D*/:
			rightValue = bIsPressed;
			break;
		case 0x57 /*W*/:
			upValue = bIsPressed;
			break;
		case 0x53 /*S*/:
			downValue = bIsPressed;
			break;
	}
}
